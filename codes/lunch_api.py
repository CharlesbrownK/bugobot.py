class BugoLunchMenu:
    ...
    def __init__(self):
        ...
        # get url
        self.today_url = 'https://schoolmenukr.ml/api/high/J100000579?year=2022&allergy=hidden' + today_month + today_date
        self.tomorrow_url = 'https://schoolmenukr.ml/api/high/J100000579?year=2022&allergy=hidden' + tomorrow_month + tomorrow_date
